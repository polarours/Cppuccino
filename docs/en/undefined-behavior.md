...
### 1.2 Why C++ Allows Undefined Behavior
...
### 2.3 Use of Uninitialized Variable
...
## 3. Coping With Undefined Behavior
...
### 3.2 Using Static and Dynamic Analysis Tools
...
#### 3.2.1 Static Analysis Tools (Clang-Tidy as an Example)
...
#### 3.2.2 Dynamic Analysis Tools (AddressSanitizer as an Example)
...
### 3.3 Defensive Programming in Practice
